...
export default class Menu {
  ...
  renderMenuInfo(menu) {
    const container = DOMHelper.createElement('div', ['col-6']);
    const menuTextElement = DOMHelper.createElement('p', ['lead']);
  ...
  renderMenuContainer(menuItem) {
    const container = DOMHelper.createElement('div', ['row', 'text-center']);
