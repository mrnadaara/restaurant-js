...
export default class Contact {
  ...
  renderEmail() {
    const container = DOMHelper.createElement('div', ['form-group']);
    const label = DOMHelper.createElement('label', null, [
    ...
    small.innerText = 'We will never share your email with anyone else.';
  ...
  renderFormContainer() {
    ...
    const formElement = DOMHelper.createElement('form', ['w-50', 'pb-5']);
  ...
  renderHeader() {
    ...
    const headerElement = DOMHelper.createElement('h1', [
      'text-dark',
      'display-4',
    ]);
  ...
  render() {
    ...
    const innerContainer = DOMHelper.createElement('div', ['container']);
